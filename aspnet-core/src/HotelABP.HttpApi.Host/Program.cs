...
public class Program
{
    public async static Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            // 加载本地机密配置
            builder.Configuration
                .AddJsonFile(@"C:\Users\21849\AppData\Roaming\Microsoft\UserSecrets\HotelABP-4681b4fd-151f-4221-84a4-929d86723e4c\secrets.json", optional: true, reloadOnChange: true);
